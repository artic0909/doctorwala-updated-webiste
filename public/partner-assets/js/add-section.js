...
addButton.addEventListener("click", () => {
  ...
  newSection.innerHTML = `
            ...
            <div class="col-4 form-group">
                <label for="doctor_visit_start_time" style="font-weight: 700;">
                    <i class="fa-solid fa-clock text-primary"></i>
                    Time From <span class="text-danger">*</span>
                </label>
                <input type="time" class="form-control" style="height: 55px;" name="doctor_visit_start_time[]" id="doctor_visit_start_time">
            </div>

            <div class="col-4 form-group">
                <label for="doctor_visit_end_time" style="font-weight: 700;">
                    <i class="fa-solid fa-clock-rotate-left text-primary"></i>
                    Time To <span class="text-danger">*</span>
                </label>

                <div class="d-flex align-items-center">
                    <input type="time" class="form-control" style="height: 55px;" name="doctor_visit_end_time[]" id="doctor_visit_end_time">
