                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-8 grid-margin stretch-card mx-auto">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Bulk WhatsApp Broadcast</h4>
                                    <p class="card-description">
                                        Upload an image and a customer CSV to send a WhatsApp template message to everyone on the list.
                                    </p>
                                    <form class="forms-sample" method="POST" action="{{ url('/superadmin/bulkmessage/send') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="image">Template Image <span class="text-danger">*</span></label>
                                            <input type="file" class="form-control" id="image" name="image" accept="image/png, image/jpeg, image/jpg" required>
                                            <small class="text-muted">Allowed formats: jpeg, png, jpg (Max 2MB)</small>
                                        </div>
                                        <div class="form-group">
                                            <label for="csv_file">Customer CSV <span class="text-danger">*</span></label>
                                            <input type="file" class="form-control" id="csv_file" name="csv_file" accept=".csv, .txt" required>
                                            <small class="text-muted">The CSV should contain phone numbers (e.g., 9876543210). First column is parsed.</small>
                                        </div>
                                        <button type="submit" class="btn btn-primary mr-2">Send Broadcast</button>
                                    </form>
                                </div>
                            </div>
                        </div>
