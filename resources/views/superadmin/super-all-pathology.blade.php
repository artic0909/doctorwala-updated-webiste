    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
                ...
                <form method="GET" action="{{ route('superadmin.super-all-path') }}" class="d-flex w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p class="m-0" style="text-transform: capitalize;"><b class="text-dark">Address: </b><b class="text-success">{{ \Illuminate\Support\Str::limit($path->clinic_address, 10, '...') }}</b></p>
                                                </td>
