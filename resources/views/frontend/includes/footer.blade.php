<a href="/partner-register" style="color: white; text-decoration: none;">
    <marquee id="marqueeText"
        style="background: #051225; color: white; padding: 10px; position: fixed; bottom: 0; width: 100%; z-index: 1000; font-family: Arial, sans-serif; font-size: 15px;">
        <span style="
            font-weight: 600; 
            margin-left: 10px; 
            color: #ff4d4d; 
        ...
        ">
            Click The Bar to Join,
        </span>

        Be a Part of <b>Doctorwala.info</b> - Empowering Healthcare Across India!
        If you are a Doctor, Clinic, OPD, Pathologist or Medical Store owner, this is your opportunity to grow digitally.
        Get more visibility, more patients, and seamless connectivity.
