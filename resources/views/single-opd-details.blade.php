                ...
                <div class="doc-body">
                    <div class="doc-body-inner">
                        ...
                        <div class="doc-aside">
                            ...
                            <div class="doc-btns">
                                <button class="btn-appt" onclick="openM('inquiryModal{{ $opd->id }}', '{{ $doctor->id }}')">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                        <rect x="3" y="4" width="18" height="18" rx="2" />
                                        <line x1="16" y1="2" x2="16" y2="6" />
                                        <line x1="8" y1="2" x2="8" y2="6" />
    ...
    <div class="modal-box">
        ...
        <div class="mbody">
            <form action="{{ route('dw.opd.inquiry.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="doctor_id" id="doctor_id_field">
                <div class="fg">
...
<script>
    ...
    // Modals
    function openM(id, doctorId = null) {
        ...
        if (e) {
            ...
            if (doctorId) {
                const input = e.querySelector('input[name="doctor_id"]');
                if (input) {
